...
import com.example.springbootannotation.mapper.UserMapper;
...
public class UserController {
    ...
    public User getOne(@PathVariable("username") String username, @PathVariable("password") String password){
